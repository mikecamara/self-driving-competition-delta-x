...
# CONTROLLER_TYPE = 'MM1'            #(ps3|ps4|xbox|nimbus|wiiu|F710|rc3|MM1|custom) custom will run the my_joystick.py controller written by the `donkey createjs` command
...
BEHAVIOR_LIST = ['Left_Lane', "Right_Lane", "Straight"]
BEHAVIOR_LED_COLORS =[ (0, 10, 0), (0, 0, 10), (10, 0, 0) ] #RGB tuples 0-100 per chanel
...
# AI_LAUNCH_THROTTLE = 1.3            # the ai will output this throttle value
# AI_LAUNCH_ENABLE_BUTTON = 'R2'      # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
# AI_LAUNCH_KEEP_ENABLED = False      # when False ( default) you will need to hit the AI_LAUNCH_ENABLE_BUTTON for each use. This is safest. When this True, is active on each trip into "local" ai mode.
# 
# #Scale the output of the throttle of the ai pilot for all model types.
AI_THROTTLE_MULT = 1.00         # this multiplier will scale every throttle value for all output from NN models
# 
# AI_THROTTLE_MULT = 1
